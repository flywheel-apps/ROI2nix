...
METHOD_SLICER = MethodTypes(
    method="slicer", valid_source=slicer_valid_source, valid_dest=slicer_valid_dest
)

plastimatch_valid_source = ["dicom", "nifti"]
plastimatch_valid_dest = ["nifti", "nrrd"]
METHOD_PLASTIMATCH = MethodTypes(
    method="plastimatch",
...
METHOD_DICOM2NIFTI = MethodTypes(
    method="dicom2nifti",
